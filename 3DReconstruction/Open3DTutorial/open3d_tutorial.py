...
def download_fountain_dataset():
    fountain_path = _relative_path("Open3DTutorial/TestData/fountain_small")
    fountain_zip_path = _relative_path("Open3DTutorial/TestData/fountain.zip")
...
def get_armadillo_mesh():
    armadillo_path = _relative_path("Open3DTutorial/TestData/Armadillo.ply")
...
def get_knot_mesh():
    mesh = o3d.io.read_triangle_mesh(_relative_path("Open3DTutorial/TestData/knot.ply"))
    mesh.compute_vertex_normals()
    return mesh
